    ...
    public void showConfigurationSucessfulMessage() {
        if (!MavidWifiConfigureSpeakerActivity.this.isFinishing()) {
            ...
            btn_ok.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    alert.dismiss();
                    Intent newIntent = new Intent(MavidWifiConfigureSpeakerActivity.this, AlexaSignInActivity.class)
        ...
        try {
            MavidApplication.setDeviceListener(new DeviceListener() {
                ...
                public void newDeviceFound(final DeviceInfo deviceInfo) {
                    LibreLogger.d(this, "atul_wifi_direct_issue_suma in newdevice found connect to wifi activity" + deviceInfo.getFriendlyName());
                    ...
                    if (isThisDeviceLookingFor(deviceInfo) && !configuredeDeviceFound) {
                        ...
                        Log.v("atul_wifi_direct_iss_StoringDeviceIp", "Storing MavidWifi " + mSACConfiguredIpAddress);
                        ...
                        if (!callWaitForDiscoveryOnce) {
                            Log.d("atul_wifi_direct_iss_wait_for_dis", "configured device found");
...
//                updateConnectionStatus(getResources().getString(R.string.connectingToWifi));
                ...
                LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi http done successfully");
                ...
                if (getconnectedSSIDname(MavidWifiConfigureSpeakerActivity.this).equalsIgnoreCase(ssid)) {
                    ...
                    LibreLogger.d(this, "atul_wifi_direct_issue_Connected To Main SSID " + ssid);
//                    alertForNetworkChange(MavidWifiConfigureSpeakerActivity.this);
                    ...
                    LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi msearch interval of time");
                    waitForDiscovery();
...
//                Toast.makeText(MavidWifiConfigureSpeakerActivity.this, getString(R.string.httpPostFailed), Toast.LENGTH_LONG).show();
                LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi http post failed");
...
//                updateConnectionStatus(getResources().getString(R.string.searchingForDevice));
                ...
                LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi searchingfordevice");


            } else if (msg.what == Constants.TIMEOUT_FOR_SEARCHING_DEVICE) {
                showDialogifDeviceNotFound(getString(R.string.noDeviceFound));
                LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi nodevicefound");
...
//                enableAlexaLogin();
                ...
                LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi devicefound");
...
//                    isAutoNetworkChangeShownOnce = true;
//                }
                LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi wrongnw: id " + getconnectedSSIDname(MavidWifiConfigureSpeakerActivity.this));
                ...
                if (mWifi.isConnected()) {
                    if (getconnectedSSIDname(MavidWifiConfigureSpeakerActivity.this).contains(ssid)) {
                        ...
                        LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi wifisucess");
...
//                        }
                        LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi unknownssid");

                    }
                } else {
                    alertBoxForNetworkOff();
                    LibreLogger.d(this, "atul_wifi_direct_issue_suma in connectTowifi wrongnetwork");
                }
