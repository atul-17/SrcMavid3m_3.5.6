...
public class HotSpotOrSacSetupActivity extends BaseActivity implements OnClickListener, BleWriteInterface, BleReadInterface {
    ...
    public static HotSpotOrSacSetupActivity hotSpotOrSacSetupActivity;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hotSpotOrSacSetupActivity = this;
...
//        EventBus.getDefault().register(this);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btnYes:
                Intent intent = new Intent(HotSpotOrSacSetupActivity.this, BLEHotSpotCredentialsActivity.class);
            ...
            case R.id.btnNo:
                ...
                if (MavidApplication.BLEServiceisNullScanREQ) {
                    ...
                    Intent intentBLE = new Intent(HotSpotOrSacSetupActivity.this, BLEConfigureActivity.class);
    ...
    protected void onDestroy() {
        ...
        hotSpotOrSacSetupActivity = null;
    }
