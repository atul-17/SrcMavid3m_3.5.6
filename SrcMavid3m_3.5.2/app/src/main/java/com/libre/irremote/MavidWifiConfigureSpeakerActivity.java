...
//                }
                ...
                if(!ssid.equals(getconnectedSSIDname(MavidWifiConfigureSpeakerActivity.this))){
                    ShowAlertDynamicallyGoingWrongNetwork("",getResources().getString(R.string.title_error_connection) + "( " + getconnectedSSIDname(MavidWifiConfigureSpeakerActivity.this) + ")" +
