package com.mavid.fragments.irMultipleRemotes.remotelistadapters
...
class RemoteListAdapters(private val context: Context, remoteList: ArrayList<String>, onClickinterface: OnButtonClickListViewInterface) : RecyclerView.Adapter<RemoteListAdapters.RemoteListBottomSheetHolder>() {
