...
import com.mavid.fragments.irMultipleRemotes.IRAddRemoteVPActivityNew
...
class IRTvOrTvpRemoteSelectionFragment : Fragment() {
    ...
    fun gotoNextActivity(selectedAppliance: String) {
        ...
        val intent = Intent(getActivityObject()!!, IRAddRemoteVPActivityNew::class.java)
        var bundle = Bundle()
    ...
    fun buildRemotePayloadJson(remoteId: Int): JSONObject {
        ...
        remoteIndex = RemoteIndexGetter.getNextRemoteIndex(getActivityObject())
    ...
    fun buidlRenoteDetails(isUpdate: Boolean, remoteIndex: Int, remoteId: Int, customName: String): ModelRemoteDetails {
        ...
        if (isUpdate) {
            ...
            modelRemoteDetails.index = RemoteIndexGetter.getNextRemoteIndex(getActivityObject())
