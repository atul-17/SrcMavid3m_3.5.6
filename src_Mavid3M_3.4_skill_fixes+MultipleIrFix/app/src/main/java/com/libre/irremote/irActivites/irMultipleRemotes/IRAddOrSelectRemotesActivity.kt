...
class IRAddOrSelectRemotesActivity : AppCompatActivity(), OnButtonClickListViewInterface {
    ...
    fun setRemoteSelectionAdapter() {
        ...
        remoteListAdapters = RemoteListAdapters(this@IRAddOrSelectRemotesActivity, remoteList, this)
